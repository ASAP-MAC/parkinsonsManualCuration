...
The resulting metadata and accompanying assay data can be accessed with [parkinsonsMetagenomicData](https://github.com/ASAP-MAC/parkinsonsMetagenomicData) and the [data dictionary is here](https://github.com/ASAP-MAC/parkinsonsMetagenomicData/blob/devel/inst/extdata/data_dictionary.csv).
